...
# Note: L'import 'monitor_control' devrait être importé directement,
# car ses fonctions 'start_monitor' et 'stop_monitor' contiennent déjà le décorateur.
...
def register_handlers(app: Application):
    ...
    # Gestion des admins
    # Note: Si la whitelist est vide, la première exécution de '/whitelist_add'
    # doit être faite SANS le décorateur 'whitelist_required' dans l'implémentation du fichier.
